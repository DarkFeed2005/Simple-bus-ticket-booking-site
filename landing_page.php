...
<body>
    ...
    <form action="" method="post" class="firstform">
        ...
        from: <select name="src_name" id="src_id">
            <option value="Durgapur">Ambalangoda</option>
            <option value="Burnpur">Galle</option>
            <option value="Bishnupur">Katharagama</option>
            <option value="Dubrajpurpur">Elpitiya</option>
            <option value="Kolkata">Kadawatha</option>
        </select><br>
        to: <select name="to_name" id="to_id">
            <option value="Durgapur">Ambalangoda</option>
            <option value="Burnpur">Elpitiya</option>
            <option value="Bishnupur">Katharagama</option>
            <option value="Dubrajpurpur">Kadawatha</option>
            <option value="Kolkata">Galle</option>
